...
exports.extract_url = function(url) {
    return url.match(/^[^\?]+/)[0];
};
...
var Unshorteners = {
    ...
    bitly: function (url, account, callback) {
        ...
        var qs = { shortUrl: exports.extract_url(url.href),  login: account.username, apiKey: account.apikey };
    ...
    googl: function (url, apikey, callback) {
        callback = arguments[arguments.length-1];
        var qs = { shortUrl: exports.extract_url(url.href) };
